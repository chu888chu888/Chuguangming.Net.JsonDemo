...
public sealed  class AccessHelper
{
    ...
    public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
    {
        ...
        if ((parameterValues != null) && (parameterValues.Length > 0))
        {
            ...
            OleDbParameter[] commandParameters = AccessHelperParameterCache.GetSpParameterSet(connectionString, spName);
    ...
    public static int ExecuteNonQuery(OleDbConnection connection, string spName, params object[] parameterValues)
    {
        ...
        {
            // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
            OleDbParameter[] commandParameters = AccessHelperParameterCache.GetSpParameterSet(connection, spName);
    ...
    public static int ExecuteNonQuery(OleDbTransaction transaction, string spName, params object[] parameterValues)
    {
        ...
        {
            // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
            OleDbParameter[] commandParameters = AccessHelperParameterCache.GetSpParameterSet(transaction.Connection, spName);
    ...
    /// <param name="commandText">The stored procedure name or T-SQL command</param>
    /// <param name="commandParameters">An array of OleDbParameters to be associated with the command or 'null' if no parameters are required</param>
    /// <param name="connectionOwnership">Indicates whether the connection parameter was provided by the caller, or created by AccessHelper</param>
    ...
    public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static int ExecuteNonQueryTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static int ExecuteNonQueryTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static OleDbDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static OleDbDataReader ExecuteReaderTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static OleDbDataReader ExecuteReaderTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static object ExecuteScalarTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static object ExecuteScalarTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return AccessHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return AccessHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
